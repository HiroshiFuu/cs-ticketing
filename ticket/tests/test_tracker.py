...
from ticket.models import Task, Comment
from ticket.mail.consumers import tracker_consumer
...
def test_tracker_task_creation(todo_setup, django_user_model):
    ...
    msg["References"] = "<thread-{}@cs-support-ticket> <unknown@example.com>".format(task.pk)
