...
from ticket.models import Attachment
from ticket.utils import remove_attachment_file
...
def remove_attachment(request, attachment_id: int) -> HttpResponse:
    ...
    if request.method == "POST":
        ...
        redir_url = reverse("ticket:task_detail", kwargs={"task_id": attachment.task.id})
