...
class Task(LogMixin):
    ...
    task_list = models.ForeignKey(Company, on_delete=models.CASCADE, verbose_name='Company')
    ...
    credits_comsumed = models.FloatField(blank=True, null=True, verbose_name='Credits Comsumed')
    ...
    def get_absolute_url(self):
        return reverse('ticket:task_detail', kwargs={'task_id': self.id})
