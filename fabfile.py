# Update cs-ticketing.sg with latest "shell site" and dependencies
# (most importantly cs-ticketing). Migrate, collecstatic, then restart
# gunicorn and nginx.
...
REPO_URL = "https://github.com/hiroshifuu/cs-ticketing.git"
SITE_DIR = "/home/user/cs-ticketing"
env.user = "user"
env.hosts = ["0.0.0.0"]
